        ...
        <footer className="fixed-bottom">
            <div class="card bg-dark text-white">
                <div className="row m-auto">
                    ...
                    <a className="nav-link" href="https://github.com/maxgoldstein93/reactPortfolio/blob/main/public/assets/Max_Goldstein_October_Resume.pdf?raw=true" target="_blank"><i style={styles} className="far fa-file fa-2x"></i></a>
